...
handleQuery:
    ...
    ;Parse M as cmd[0].b2b1
    MOV.B  (cmd), R_M
    RRA    R_M
    AND  #0x03, R_M
    MOV.B R_M, &(MEM_MAP_INFOC_START + 4)
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;Parse Target as cmd[1].b3
    MOV.B (cmd+1), R_scratch0
    RRA.B R_scratch0
    RRA.B R_scratch0
    RRA.B R_scratch0
    AND.B #0x01, R_scratch0
    MOV.B R_scratch0, &(MEM_MAP_INFOC_START + 2)
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

    ;MOV.B  R_scratch0, R_M
    ;MOV.B  #0x02, R_M
	...
	ADD		#MEM_MAP_INFOD_START, R_scratch0 ;[] offset the index into the table
...
ackTimingLoop:
	...
	;MOV.B   #0x00,         R_M
	;MOV.B   rfid.R,         R_M
    MOV.B &(MEM_MAP_INFOC_START + 4), R_M
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;NO HIT
