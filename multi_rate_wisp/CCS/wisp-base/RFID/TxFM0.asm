...
;/SCRATCH REGISTERS-------------------------------------------------------------------------------------------------------------------
R_M         .set    R11             ; Entry: M? encoding scheme (FM0/M2/M4/M8)
...
Miller2:
    CMP.B #0x01, R_M
    JNZ Miller4
; //////////////////////// Deal with Pilot Tone ///////////////////////////////
    TST.B R_TRext
    JNZ M2_TRextIs_1
    MOV #0004h, R_scratch3
    JMP M2_otherSetup
M2_TRextIs_1:
    MOV #000fh, R_scratch3

M2_otherSetup:
    MOV.B   #0xFF, R_scratch1		;[1] preloading our HIGH and LOW Tx bits to save us some cycles for pilot tones and preamble
    MOV.B   #0x00, R_scratch0

    MOV #0x00, R_prevState ; PREV
    MOV #0xFF, R_scratch2 ; PrevBit
M2_M_LF_Count:
...
M2_M_LF_Count_End:
; ///////////////////// Pilot Tone Ends Here /////////////////////////////////
M2_Send_Preamble:
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*HLHL*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    ...
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*HLLH*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    ...
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*LHLH*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    ...
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*LHHL*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
...
M2_Send_a_Byte:
    ; Bit 0
    NOP ;[1]
    OR R_currByte, R_scratch2 ;[1]
    XOR R_scratch2, R_prevState ;[1]
    MOV.B   R_prevState, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx4							;[5] 5 timing cycles

    INV.B R_prevState ; [1]
    MOV.B   R_prevState, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx3							;[5] 5 timing cycles
    XOR R_currByte, R_prevState ;[1] if bit=1, there is an additional flip in the middle
...
M4_Send_Preamble:
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*HLHLHLHL*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    ...
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*HLHLLHLH*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    ...
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*LHLHLHLH*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    ...
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*LHLHHLHL*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
...
M8_Send_Preamble:
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*HLHLHLHLHLHLHLHL*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    ...
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*HLHLHLHLLHLHLHLH*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    ...
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*LHLHLHLHLHLHLHLH*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    ...
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX       /*LHLHLHLHHLHLHLHL*/
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch1, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
    NOPx5							;[5] 5 timing cycles
    MOV.B   R_scratch0, &PTXOUT		;[4] HIGH on PTXOUT.PIN_TX
