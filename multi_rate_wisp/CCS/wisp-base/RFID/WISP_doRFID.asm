...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    TST.B &(MEM_MAP_INFOC_START + 2)
    JZ NO_Retransmission
    SUB.B #(4), &(MEM_MAP_INFOC_START)
    MOV.B #(0), &(MEM_MAP_INFOC_START + 2)

NO_Retransmission:
    INC.B &(MEM_MAP_INFOC_START)
    MOV.B &(MEM_MAP_INFOC_START), &(dataBuf+13)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	MOV		#(dataBuf + 11),		R13		;[2] load &dataBuf[0] as dataPtr
	MOV		#(3),			R14		;[2] load num of bytes in ACK
...
keepDoingRFID: ; tag prepares epc after sending RN16
;/************************************************************************************************************************************
;/										SET TO FASTER CLOCK               						                                     *
;/************************************************************************************************************************************
	DINT 									;[] safety
...
callQueryHandler:
	CALLA	#handleQuery
	JMP		endDoRFID;;URRRRRRRRRRRRRRRRRRRR
...
callAckHandler:
	...
	CALLA	#handleAck
	JMP		WISP_doRFID;URRRRRRRRRRRRRRRRRR
